 ...
 */
@WebServlet("/CanteenbookNameServlet")
public class CanteenbookNameServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CanteenbookNameServlet() {
        super();
    ...
    List<String> name=pd.getcanteenbook(canteenid);
