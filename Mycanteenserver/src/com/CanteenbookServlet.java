...
/**
 * Servlet implementation class CanteenbookServlet
 */
@WebServlet("/CanteenbookServlet")
public class CanteenbookServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CanteenbookServlet() {
        super();
    ...
    int rflag=pd.addcanteenbook(canteenid, year,month,day,lunchordinner,
        peoplenumber,name,phonenumber);
